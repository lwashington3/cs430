...
\begin{enumerate}
	...
	\oldanswer{The first few inserts run in $O(1)$ time in the continious memory that was initially assigned.
...
\begin{enumerate}[start=2]
	...
	\oldanswer{Price for each increment = \$2. Cost to flip a bit = \$1
	\begin{table}[H]
	    \centering
	    \begin{threeparttable}
