...
\begin{enumerate}[label=\arabic*.]
	...
	\item What if our collection of data is changing (dynamic), would either of these approaches work efficiently for a collection of data that has inserts and deletes happening? \answer{No, you would have to re-run both algorithms if the data is dynamic.}
\end{enumerate}
