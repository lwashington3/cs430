...
\begin{enumerate}[label=\arabic*.]
	...
	\oldanswer{If you remove an item that was in the optimal answer, then you have a new problem where the weight limit is $W - w_{i}$ and items $1\dots i-1$. If you remove an item that was not in the optimal answer, then you have a new problem with items $1\dots i-1$ with the same weight limit $W$.\begin{table}[H]
	    \centering
