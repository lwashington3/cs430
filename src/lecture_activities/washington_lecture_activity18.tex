...
\begin{enumerate}
	...
	\answer{As stated before, the earliest end time/lastest start time methods are the only greedy choices that'll work.}
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.,start=2]
	\item Try to prove Optimal Substructure for the above two problems.\answer{\begin{enumerate}
