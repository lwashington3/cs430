...
\begin{enumerate}[label=\arabic*.]
	...
	\item Step 3: Compute solution using a table bottom up for the Longest Common Subsequence problem. Use your answer to question \hyperref[prb:15-3]{3} above. Note the overlapping sub-problems as you go. \oldanswer{\begin{table}[H]
	    \centering
	    \begin{threeparttable}
