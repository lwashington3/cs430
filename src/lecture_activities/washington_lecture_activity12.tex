...
\begin{enumerate}[label=\arabic*.]
    \item What do you think the issue we need to handle when deleting a node from a red-black tree? How does red-black delete differ from a \hyperref[alg:bst-delete]{BST delete}?
\end{enumerate}
...
AVL Visualization: \url{https://visualgo.net/bn/bst}
%</Lecture-Activity-12>
