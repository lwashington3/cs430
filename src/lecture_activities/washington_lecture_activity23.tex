...
\begin{enumerate}
	...
	\answer{$n$ make sets; $n-1$ unions; findsets?}
\end{enumerate}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{scope}
	\end{tikzpicture}
	\answer{\caption{$V = \{ a, b, c, d, e, f, g, h, i, j \}$, $E=\{ \{a,b\}, \{ a,c \}, \{ c,b \}, \{ b,d \}, \{ e,g \}, \{e,f\}, \{ h,i \} \}$}}
...
\begin{enumerate}[start=2]
	...
	\answer{\Call{Make-Set}{} runs in $O(1)$, since you're creating the element, setting the $tail$ pointer to this new element, and creating a pointer back to the head.
	...
	\answer{Try the ``pairwise approach'' to get a lower bound.\begin{table}[H]
	    \centering
