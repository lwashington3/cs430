...
\begin{enumerate}[label=\arabic*.]
    ...
    \item Step 3: Compute solution using a table bottom up for the Optimal Binary Search Tree problem. Use your answer to question \hyperref[question:4]{4} above. Note the overlapping sub-problems as you go. \answer{\renewcommand{\element}[2]{$#1_{#2}$}\begin{table}[H]
        \centering
