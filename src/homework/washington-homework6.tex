...
\begin{enumerate}[label=\arabic*.]
	...
	\item (6 points)
Show the data structure that results and the answers returned by the FIND-SET operations in the following program. Use the linked-list representation with the weighted-union heuristic.	% FIXME: Add the code and the table
