...
% Preamble
\documentclass[13]{cs430recitation}
...
\begin{enumerate}
	...
	\begin{enumerate}
	    \item Linked List
		\begin{answer}\item Tree\end{answer}
	...
	\begin{enumerate}
	    \item Once
		\item Twice
		\begin{answer}\item Equivalent to number of indegree of the node\end{answer}
		\item Thrice
	\end{enumerate}
	...
	\begin{enumerate}
	    ...
	    \begin{answer}\item Directed Acyclic Graphs\end{answer}
	\end{enumerate}
	...
	\begin{enumerate}
		...
		\begin{answer}\item Removing one edge from the spanning tree will not make the graph disconnected\end{answer}
	\end{enumerate}
	...
	\begin{enumerate}
		...
		\begin{answer}\item It can accept cycles in the MST\end{answer}
	...
	\begin{enumerate}
	    \item True
		\begin{answer}\item False\end{answer}
	\end{enumerate}
	...
	\begin{enumerate}[label=\arabic{enumi}\alph*.]
		...
		\begin{answer}Consider the directed graph below. If we run the DFS on this directed graph from $w$, then we can't visit\end{answer}%
	\end{enumerate}
