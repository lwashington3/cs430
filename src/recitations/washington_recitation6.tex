...
% Preamble
\documentclass[6]{cs430recitation}
...
\begin{enumerate}
	...
	\end{enumerate}
	\item If you were just given the output of a traversal of a valid binary tree, could you draw the actual BST? Which of the following traversals is/are needed to draw the BST from given traversals.\begin{table}
	    \centering
