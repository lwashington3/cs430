...
\begin{enumerate}
	...
	\begin{enumerate}[label=\arabic{enumi}\alph*)]
	    \item Write pseudocode to sum each contiguous subsequence (from $a_{i}$ to $a_{j}$) and keep track of the maximum one. What is the runtime of your algorithm? \answer{The runtime is $O(n^{2})$ \begin{algorithm}[H]
	    		...
	    		\end{algorithmic}
	    	\end{algorithm}}
		\item Now find an $O(n)$ algorithm. Give pseudocode.\answer{\begin{algorithm}[H]
