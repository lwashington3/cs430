...
% Preamble
\documentclass[12]{cs430recitation}
...
\begin{enumerate}
	...
	\begin{enumerate}
	    \item \oldanswer{\Call{Insertion}{}, \Call{Union}{}}
	...
	\begin{figure}[H]
		...
		\label{fig:12.1}
	\end{figure}
	\oldanswer{Remove 7 from the list and add its children to the root list. Then remerge.}
